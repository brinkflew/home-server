...
> **Executed on 2026-08-12. This is a record as much as a procedure.**
>
> Everything from *Pre-install* through *Install* describes the **Fedora 37 and Docker Compose**
> host that no longer exists, and its commands (`docker compose down`, and the disk image of a btrfs
> root) refer to a system that is gone. They are kept unedited because rewriting them would falsify
> what was actually done, and because a future reinstall follows the same shape.
>
> Still live, and worth reading on their own: **Restore**, **Verify**, **Updating** and
> **Rollback**. The reboot procedure under *Updating* is now `bin/reboot-host.sh`.
...
curl -sSL https://github.com/restic/restic/releases/download/v0.19.1/restic_0.19.1_linux_amd64.bz2 \
